...
image_menu		VARCHAR2(3000),
foodtype			VARCHAR2(30),
constraint FK_oriental FOREIGN KEY (foodid) REFERENCES mealplanner(foodid)
);
...
image_menu		VARCHAR2(3000),
foodtype			VARCHAR2(30),
constraint FK_western FOREIGN KEY (foodid) REFERENCES mealplanner(foodid)
);
...
delete from thumbnailBoard where articleNumber = 11;

update thumbnailBoard set title = 'No title',boardContent ='not first article' where articleNumber = 10;
